...
function Configure()
{
    ...
    if ($mod_admin_news == 1) {
        echo '<input type="radio" class="form-check-input" id="xmod_admin_news_a" name="xmod_admin_news" value="1" checked="checked" />
        ...
        echo '<input type="radio" class="form-check-input" id="xmod_admin_news_a" name="xmod_admin_news" value="1" />
            <label class="form-check-label" for="xmod_admin_news_a">' . adm_translate('Administrateurs') . ' / ' . adm_translate('Modérateurs') . '</label>
        </div>
        <div class="form-check form-check-inline">
    ...
    if ($moderate == 1) {
        echo '<option value="1" selected="selected">' . adm_translate('Modération par l\'Administrateur') . '</option>
            <option value="2">' . adm_translate('Modération par les Utilisateurs') . '</option>
            <option value="0">' . adm_translate('Pas de modération') . '</option>';
    } elseif ($moderate == 2) {
        echo '<option value="1">' . adm_translate('Modération par l\'Administrateur') . '</option>
    ...
    echo '<input class="form-control" id="xtroll_limit" type="text" name="xtroll_limit" value="' . $troll_limit . '" min="1" maxlength="3" required="required" />
                </div>
            </div>
        </div>
        <script type="text/javascript">
    ...
    echo '<input class="form-control" type="text" id="xavatar_size" name="xavatar_size" value="' . $avatar_size . '" size="11" maxlength="10" />
        </div>
    </div>
    <div class="mb-3 row">
    ...
    $fv_parametres = 'xadmin_cook_duration: {
            validators: {
                regexp: {
                    regexp:/^\d{1,10}$/,
                    message: "0-9"
    ...
    $arg1 = 'const settingspref = document.getElementById("settingspref");
