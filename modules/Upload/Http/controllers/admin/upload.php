...
function upConfigure($ModPath, $ModStart, $f_meta_nom, $f_titre, $adminimg)
{
    ...
    if (isset($subop) and $subop == 'uploadSave') {
        echo '<div class="alert alert-success alert-dismissible fade show" role="alert">
                <strong>' . upload_translate('Modifications enregistrées dans') . '</strong> <code class="code">/modules/upload/config/config.php</code>.
    ...
    $arg1 = 'var formulid = ["settingsupload"];
