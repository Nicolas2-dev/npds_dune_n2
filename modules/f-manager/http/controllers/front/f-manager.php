        ...
        if ($dircmd_fma[1]) {
            ...
            if ($auto[0]) {
                ...
                if (file_exists($auto[3] . '/' . $auto[2])) {
                    ...
                    $rename_dir = '<form method="post" action="modules.php">
    ...
    case 'pict':
        ...
        if ($auto[0]) {
            ...
            if (file_exists($auto[3] . '/' . $auto[2])) {
                ...
                $pict_dir .= '<input class="form-control" type="number" id="maxthumb" name="maxthumb" size="4" value="' . $Max_thumb . '" />
                </div>
                <div class="mb-3">
...
$extensions = require 'modules/' . $ModPath . '/config/extensions.php';
...
$att_icon_default = '<span class="fa-stack">
    <i class="bi bi-file-earmark-fill fa-stack-2x text-body-secondary"></i>
    <span class="fa-stack-1x filetype-text ">?</span>
</span>';

$att_icon_multiple = '<span class="fa-stack">
    <i class="bi bi-file-earmark-fill fa-stack-2x text-body-secondary"></i>
    <span class="fa-stack-1x filetype-text ">...</span>
</span>';
