...
function ListReseaux($ModPath, $ModStart)
{
    ...
    <div class="help-block">' . rs_translate('Liste des réseaux sociaux mis à disposition par l\'administrateur.') . '</div>
        <hr />
        <h3>
            <a href="modules.php?ModPath=' . $ModPath . '&amp;ModStart=' . $ModStart . '&amp;op=EditReseaux">
                <i class="fa fa-edit fa-lg"></i>
            </a>&nbsp;' . rs_translate('Editer') . '
        </h3>
        <div class="row mt-3">';
        ...
        echo '<div class="col-sm-6">
            <fieldset>
                ...
                <span class="help-block text-end">
                    <span id="countcar_rs_uid' . $i . '"></span>
                </span>
        ...
        <div class="my-3 row">
            <div class="col-sm-6">
                <button class="btn btn-primary col-12" type="submit">
                    <i class="fa fa-check fa-lg"></i>&nbsp;' . rs_translate('Sauvegarder') . '
                </button>
