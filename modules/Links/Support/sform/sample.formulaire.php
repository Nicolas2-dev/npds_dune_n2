...
$m->addTitle('Fiche Compl&eacute;mentaire');

// Champ text : Longueur = 40 / Pas de vérification
$m->addField('rso', 'Raison Sociale', '', 'text', false, 40, '', '');

// Champ text : Longueur = 50 / Pas de vérification
$m->addField('ad1', 'Adresse', '', 'text', false, 50, '', '');

// Champ text : Longueur = 50 / Pas de vérification
$m->addField('ad2', 'Adresse', '', 'text', false, 50, '', '');

// Champ text : Longueur = 25 / Pas de vérification
$m->addField('dpt', 'D&eacute;partement', '', 'text', false, 25, '', '');

// Champ text : Longueur = 5 / Numérique seulement
$m->addField('cpt', 'Code Postal', '', 'text', false, 5, '', '0-9');

// Champ text : Longueur = 40 / Numérique étendu seulement
$m->addField('fax', 'Fax', '', 'text', false, 40, '', '0-9extend');

// Champ text : Longueur = 70 / Email seulement
$m->addField('email', 'Adresse de messagerie', '', 'text', false, 50, '', 'email');

// Champ text : Longueur = 400 / TextArea / Pas de Vérification
$m->addField('des', 'Description', '', 'textarea', false, 400, 6, '', '');
...
$m->addSelect('f4', 'Comp&eacute;tences techniques', $tmp, false, 5, true);
...
$m->addSelect('f5', 'Niveau de service', $tmp, false, 1, false);
...
$m->addRadio('f6', "Type d'Option", $tmp, false);

// Champ Boite à cocher / Valeur de retour 100 / coché
$m->addCheckbox('f7', 'Centre de Formation Agr&eacute;&eacute;', '100', false, true);

// Commentaire
$m->addComment("<p class=\"text-center\">Ces informations sont publiques, mais vous disposez d'un droit permanent de modification.</p>");
