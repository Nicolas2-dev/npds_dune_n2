...
function Configuretwi($ModPath, $ModStart, $class_sty_2, $npds_twi_arti, $npds_twi_urshort, $npds_twi_post, $consumer_key, $consumer_secret, $oauth_token, $oauth_token_secret, $tbox_width, $tbox_height)
{
    global $language;
    ...
    echo '<h3 class="mb-3">' . twi_trad('Configuration du module npds_twi') . '</h3>
    ...
    echo '<!--
        <tr>
            <td colspan="2">
                <strong>' . twi_trad('Interface bloc') . '</strong>
            </td>
        </tr>
            <td width="30%">
    ...
    echo '<input class="btn btn-primary my-3" type="submit" value="' . twi_trad('Enregistrez') . '" />
...
if ($admin) {
    ...
    switch ($subop) {
        ...
        default:
            Configuretwi($ModPath, $ModStart, $class_sty_2, $npds_twi_arti, $npds_twi_urshort, $npds_twi_post, $consumer_key, $consumer_secret, $oauth_token, $oauth_token_secret, $tbox_width, $tbox_height);
            break;
    }
}
