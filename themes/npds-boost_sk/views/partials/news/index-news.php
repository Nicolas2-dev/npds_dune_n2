<div class="card mb-3 shadow">
    ...
    <div class="card-body">
        ...
        ?>
        <hr />
        <p class="card-text"><small class="text-body-secondary">!N_emetteur! [french]Publi&eacute; le[/french][english]Published on[/english][chinese]&#x53D1;&#x8868;[/chinese][spanish]Publicado[/spanish][german]Ver&#246;ffentlicht[/german] : !N_date! </small></p>

    </div>
    <div class="card-footer pied_art">
        <div class="row">
            <div class="col-sm-6">!N_read_more! <small class="text-body-secondary">!N_nb_carac!</small></div>
