<?php
if (Views::exists($theme_file = 'Themes/Base::Bootstrap/header_before')) {
...
if (Views::exists('Themes/Base::Bootstrap/body_onload.php')) {
...
// landing page
if (stristr($_SERVER['REQUEST_URI'], $Start_Page) && Views::exists('Themes/Base::partials/header/header_landing')) {
    $Xcontent = Views::make('Themes/Base::partials/header/header_landing');
} else {
    $Xcontent = Views::make('Themes/Base::partials/header/header');
}

//echo Metalang::metaLang(Language::affLangue($Xcontent));
echo Language::affLangue($Xcontent);

if (Views::exists($theme_file = 'Themes/Base::Bootstrap/header_after')) {
    echo Views::make($theme_file);
}
...
if (Views::exists($theme_file = 'Themes/Base::Bootstrap/footer_before')) {
    echo Views::make($theme_file);
}

$Xcontent = Views::make('Themes/Base::partials/footer/footer');
