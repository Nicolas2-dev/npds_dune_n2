...
function etape_2()
{
    ...
    //if (file_exists('install/language/licence/' . Language::languageIso(1, 0, 0) . '.txt')) {
    //    $licence_file = 'install/language/licence/' . Language::languageIso(1, 0, 0) . '.txt';
    ...
    if ($nohalt) {
        echo '<button type="submit" class="btn btn-success">' . ins_translate('J\'accepte') . '</button>';
    } else {
