...
echo '
      ...
      <table data-toggle="table" data-mobile-responsive="true">
         ...
         <tbody>
            <tr>
               <td><img src="' . (theme_image('stats/explorer.gif') ?: 'assets/images/stats/explorer.gif') . '" alt="MSIE_ico" loading="lazy"/> MSIE </td>
               <td>
            ...
            <tr>
               <td><img src="' . (theme_image('stats/firefox.gif') ?: 'assets/images/stats/firefox.gif') . '" alt="Mozilla_ico" loading="lazy"/> Mozilla </td>
               <td>
            ...
            <tr>
               <td><img src="' . (theme_image('stats/opera.gif') ?: 'assets/images/stats/opera.gif') . '" alt="Opera_ico" loading="lazy"/> Opera </td>
               <td>
            ...
            <tr>
               <td><img src="' . (theme_image('stats/chrome.gif') ?: 'assets/images/stats/chrome.gif') . '" alt="Chrome_ico" loading="lazy"/> Chrome </td>
               <td>
            ...
            <tr>
               <td><img src="' . (theme_image('stats/safari.gif') ?: 'assets/images/stats/safari.gif') . '" alt="Safari_ico" loading="lazy"/> Safari </td>
               <td>
            ...
            <tr>
               <td><img src="' . (theme_image('stats/webtv.gif') ?: 'assets/images/stats/webtv.gif') . '"  alt="WebTV_ico" loading="lazy"/> WebTV </td>
               <td>
            ...
            <tr>
               <td><img src="' . (theme_image('stats/konqueror.gif') ?: 'assets/images/stats/konqueror.gif') . '" alt="Konqueror_ico" loading="lazy"/> Konqueror </td>
               <td>
            ...
            <tr>
               <td><img src="' . (theme_image('stats/lynx.gif') ?: 'assets/images/stats/lynx.gif') . '" alt="Lynx_ico" loading="lazy"/> Lynx </td>
               <td>
            ...
            <tr>
               <td><img src="' . (theme_image('stats/altavista.gif') ?: 'assets/images/stats/altavista.gif') . '" alt="' . translate('Moteurs de recherche') . '_ico" /> ' . translate('Moteurs de recherche') . ' </td>
               <td>
      ...
      <table data-toggle="table" data-mobile-responsive="true" >
         ...
         <tbody>
            <tr>
               <td ><img src="' . (theme_image('stats/windows.gif') ?: 'assets/images/stats/windows.gif') . '"  alt="Windows" loading="lazy"/>&nbsp;Windows</td>
               <td>
            ...
            <tr>
               <td ><img src="' . (theme_image('stats/linux.gif') ?: 'assets/images/stats/linux.gif') . '"  alt="Linux" loading="lazy"/>&nbsp;Linux</td>
               <td>
            ...
            <tr>
               <td><img src="' . (theme_image('stats/mac.gif') ?: 'assets/images/stats/mac.gif') . '"  alt="Mac/PPC" loading="lazy"/>&nbsp;Mac/PPC</td>
               <td>
            ...
            <tr>
               <td><img src="' . (theme_image('stats/bsd.gif') ?: 'assets/images/stats/bsd.gif') . '"  alt="FreeBSD" loading="lazy"/>&nbsp;FreeBSD</td>
               <td>
            ...
            <tr>
               <td><img src="' . (theme_image('stats/sun.gif') ?: 'assets/images/stats/sun.gif') . '"  alt="SunOS" loading="lazy"/>&nbsp;SunOS</td>
               <td>
            ...
            <tr>
               <td><img src="' . (theme_image('stats/irix.gif') ?: 'assets/images/stats/irix.gif') . '"  alt="IRIX" loading="lazy"/>&nbsp;IRIX</td>
               <td>
            ...
            <tr>
               <td><img src="' . (theme_image('stats/be.gif') ?: 'assets/images/stats/be.gif') . '" alt="BeOS" loading="lazy"/>&nbsp;BeOS</td>
               <td>
            ...
            <tr>
               <td><img src="' . (theme_image('stats/os2.gif') ?: 'assets/images/stats/os2.gif') . '" alt="OS/2" loading="lazy"/>&nbsp;OS/2</td>
               <td>
            ...
            <tr>
               <td><img src="' . (theme_image('stats/aix.gif') ?: 'assets/images/stats/aix.gif') . '" alt="AIX" loading="lazy"/>&nbsp;AIX</td>
               <td>
            ...
            <tr>
               <td><img src="' . (theme_image('stats/android.gif') ?: 'assets/images/stats/android.gif') . '" alt="Android" loading="lazy"/>&nbsp;Android</td>
               <td>
            ...
            <tr>
               <td><img src="' . (theme_image('stats/ios.gif') ?: 'assets/images/stats/ios.gif') . '" alt="Ios" loading="lazy"/> Ios</td>
               <td>
...
echo '<h3 class="my-4">' . translate('Statistiques diverses') . '</h3>
<ul class="list-group">
   ...
   <li class="list-group-item d-flex justify-content-start align-items-center">
      <img class="me-1" src="' . (theme_image('stats/postnew.png') ?: 'assets/images/admin/postnew.png') . '" alt="" loading="lazy"/>
      ' . translate('Articles publiés') . ' <span class="badge bg-secondary ms-auto">' . wrh($snum) . ' </span>
   </li>
   <li class="list-group-item d-flex justify-content-start align-items-center">
      <img class="me-1" src="' . (theme_image('stats/topicsman.png') ?: 'assets/images/admin/topicsman.png') . '" alt="" loading="lazy"/>
   ...
   <li class="list-group-item d-flex justify-content-start align-items-center">
      <img class="me-1" src="' . (theme_image('stats/sections.png') ?: 'assets/images/admin/sections.png') . '" alt="" loading="lazy"/>
   ...
   <li class="list-group-item d-flex justify-content-start align-items-center">
      <img class="me-1" src="' . (theme_image('stats/submissions.png') ?: 'assets/images/admin/submissions.png') . '"  alt="" />
   ...
   <li class="list-group-item d-flex justify-content-start align-items-center">
      ...
      Version Num <span class="badge bg-danger ms-auto">' . $Version_Num . '</span>
   </li>
   <li class="list-group-item d-flex justify-content-start align-items-center">
      <i class="fa fa-cogs fa-2x text-body-secondary me-1"></i>
      Version Id <span class="badge bg-danger ms-auto">' . $Version_Id . '</span>
   </li>
   <li class="list-group-item d-flex justify-content-start align-items-center">
      <i class="fa fa-cogs fa-2x text-body-secondary me-1"></i>
      Version Sub <span class="badge bg-danger ms-auto">' . $Version_Sub . '</span>
   </li>
</ul>
<br />
<p class="text-center">
   <a href="https://www.npds.org" >https://www.npds.org</a> - French Portal Generator Gnu/Gpl Licence
</p>
<br />';
