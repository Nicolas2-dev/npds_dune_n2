...
use Npds\Container\Exceptions\BindingResolutionException;
...
class Container implements ArrayAccess
{
    ...
    /**
     * Tous les rappels après résolution enregistrés.
     *
     * @var array
     */
    ...
    /**
     * Tous les rappels après résolution globale.
     *
     * @var array
     */
    ...
    protected function getDependencies($parameters, array $primitives = array())
    {
        ...
        foreach ($parameters as $parameter) {
            ...
            // Vérifier si le paramètre a un type et s'il est primitif ou une classe
            if ($type && !$type->isBuiltin()) {
                $className = $type->getName();
                
                if (array_key_exists($className, $primitives)) {
