...
class FeedDate
{
   ...
   function rfc822()
   {
      ...
      if (FeedCreatorConfig::TIME_ZONE != "") $date .= " " . str_replace(":", "", FeedCreatorConfig::TIME_ZONE);
      return $date;
   }
   ...
   function iso8601()
   {
      ...
      if (FeedCreatorConfig::TIME_ZONE != "") $date = str_replace("+00:00", FeedCreatorConfig::TIME_ZONE, $date);
      return $date;
   }
