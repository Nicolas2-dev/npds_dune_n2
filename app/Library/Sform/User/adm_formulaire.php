...
if (!isset($chng_user_from)) {
    $chng_user_from = '';
}

if (!isset($chng_user_occ)) {
    $chng_user_occ = '';
}

if (!isset($chng_user_intrest)) {
    $chng_user_intrest = '';
}
...
if (!isset($chng_avatar)) {
    $chng_avatar = '';
}

if (!isset($chng_send_email)) {
    $chng_send_email = '';
}
...
$r = sql_query("SELECT rank1, rank2, rank3, rank4, rank5 
