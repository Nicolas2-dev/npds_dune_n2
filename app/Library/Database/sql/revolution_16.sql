...
INSERT INTO metalang (def, content, type_meta, type_uri, uri, description, obligatoire) VALUES('!mailadmin!', '$cmd="<a href=\\"mailto:".Spam::antiSpam($GLOBALS[''adminmail''], 1)."\\" target=\\"_blank\\">".Spam::antiSpam($GLOBALS[''adminmail''], 0)."</a>";', 'meta', '-', NULL, '[french]Affiche un lien vers l''adresse mail de l''administrateur.[/french]', '1');
