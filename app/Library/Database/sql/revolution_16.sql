...
INSERT INTO metalang (def, content, type_meta, type_uri, uri, description, obligatoire) VALUES('!connexion!', '$cmd=metaLang("!login!");', 'meta', '-', NULL, '[french]Alias de !login![/french]', '1');
