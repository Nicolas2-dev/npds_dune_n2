...
if (! function_exists('block_skin')) {
    ...
    function block_skin()
    {
        global $Default_Skin, $Default_Theme, $nuke_url, $user;
        ...
        if ($skinOn != '') {
            ...
            <script type="text/javascript">
                //<![CDATA[
                    var el = document.querySelector(\'link[href="' . $nuke_url . '/assets/shared/bootstrap/dist/css/bootstrap-icons.css"]\')
                    if (!el) {
                        el = document.createElement("link");
                        el.rel= "stylesheet";
                        el.href = "' . $nuke_url . '/assets/shared/bootstrap/dist/css/bootstrap-icons.css";
                        el.type = "text/css"
