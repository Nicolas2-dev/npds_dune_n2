	...
	<tr>
		<td style="vertical-align:top;">
		   ...
		   groupe_text(" 2,3,4,5,6")
				...
				!/!
				setCookie('forum_cat', 'cat1' , 30);">theme_img(forum/ong-npds.gif)</a>
		</td>
		<td style="vertical-align:top;">
			<a href="forum.php#"
...
<div id="forum_cat1" style="display: none;">
	<div class="detnews">Les forums g�n�raux de NPDS</div>
...
<div id="forum_cat2" style="display: none;">
	<div class="detnews">Les forums relatifs � la documentation<br />En cours de mise en place</div>
	<table width="100%" cellspacing="1" cellpadding="2" border="0">
		<tr>
			<td colspan="2" width="45%">&nbsp;</td>
			forum_bouton_subscribe()
...
<div id="forum_cat3" style="display: none;">
	<div class="detnews">Les forums relatifs aux th�mes, styles, ...<br />En cours de mise en place</div>
	<table width="100%" cellspacing="1" cellpadding="2" border="0">
		<tr>
			<td colspan="2" width="45%">&nbsp;</td>
			forum_bouton_subscribe()
