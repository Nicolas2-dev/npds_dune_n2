...
class SaveMysql extends AdminBaseController
{
    /**
    ...
    public function PrepareString($a_string = '')
    {
    ...
    public function get_table_content($table)
    {
        global $crlf;
    ...
    public function dbSave_tofile($repertoire, $linebyline = 0, $savemysql_size = 256)
    {
        global $dbname, $name, $MSos, $crlf;
