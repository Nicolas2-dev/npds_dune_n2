...
class Authors extends AdminBaseController
{
    /**
    ...
    public function displayAdmins()
    {
        ...
        while (list($a_aid, $name, $url, $email, $supadm) = sql_fetch_row($result)) {
            ...
            echo '<a href="admin.php?op=deladmin&amp;del_aid=' . $a_aid . '" ><i class="fas fa-trash fa-lg text-danger" title="' . adm_translate('Effacer l\'Auteur') . '" data-bs-toggle="tooltip" ></i></a>
                </td>
            </tr>';
        }
