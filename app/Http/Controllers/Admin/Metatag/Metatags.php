...
class Metatags extends AdminBaseController
{
    /**
    ...
    public function GetMetaTags($filename)
    {
    ...
    public function MetaTagMakeSingleTag($name, $content, $type = 'name')
    {
    ...
    public function MetaTagSave($filename, $tags)
    {
