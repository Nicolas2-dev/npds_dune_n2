...
function droits($member)
{
    ...
    if ($member > 0) {
        echo '<input type="radio" id="mem" name="privs" value="1" class="form-check-input" checked="checked" />
...
function DownloadSave($did, $dcounter, $durl, $dfilename, $dfilesize, $dweb, $duser, $ddate, $dver, $dcategory, $sdcategory, $description, $privs, $Mprivs)
{
    ...
    if ($ddate == 'yes') {
        ...
        sql_query("UPDATE " . sql_prefix('downloads') . " 
                   SET dcounter='$dcounter', durl='$durl', dfilename='$dfilename', dfilesize='$dfilesize', ddate='$time', dweb='$dweb', duser='$duser', dver='$dver', dcategory='$dcategory', ddescription='$description', perms='$privs' 
                   WHERE did='$did'");
    } else {
        sql_query("UPDATE " . sql_prefix('downloads') . " 
                   SET dcounter='$dcounter', durl='$durl', dfilename='$dfilename', dfilesize='$dfilesize', dweb='$dweb', duser='$duser', dver='$dver', dcategory='$dcategory', ddescription='$description', perms='$privs' 
                   WHERE did='$did'");
    }
