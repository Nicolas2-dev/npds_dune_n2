...
class Automated extends AdminBaseController
{
    /**
    ...
    public function puthome($ihome)
    {
        ...
        echo '<div class="mb-3 row" id="choixgroupe">
    ...
    public function autoEdit($anid)
    {
        ...
        $fv_parametres = '
            !###!
            mem_y.addEventListener("change", public function (e) {
                if(e.target.checked) {
    ...
    public function autoSaveEdit($anid, $title, $hometext, $bodytext, $topic, $notes, $catid, $ihome, $informant, $members, $Mmembers, $date_debval, $date_finval, $epur)
    {
        ...
        sql_query("UPDATE " . sql_prefix('autonews') . " 
                SET catid='$catid', title='$title', time=now(), hometext='$hometext', bodytext='$bodytext', topic='$topic', notes='$notes', ihome='$ihome', date_debval='$date_debval', date_finval='$date_finval', auto_epur='$epur' 
                WHERE anid='$anid'");
