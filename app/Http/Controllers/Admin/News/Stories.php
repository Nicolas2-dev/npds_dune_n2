...
class Stories extends AdminBaseController
{
    /**
    ...
    public function puthome($ihome)
    {
        ...
        echo '<input class="form-check-input" type="radio" id="mem_y" name="members" value="1" ' . $sel1 . ' />
    ...
    public function editStory($sid)
    {
        ...
        echo '<form id="editstory" action="admin.php" method="post" name="adminForm">
            <div class="mb-3 row">
                <label class="col-sm-4 col-form-label" for="subject">' . adm_translate('Titre') . '</label>
                <div class="col-sm-8">
    ...
    public function adminStory()
    {
        ...
        $arg1 = 'var formulid = ["storiesnewart"];
            inpandfieldlen("subject",255);
            const choixgroupe = document.getElementById("choixgroupe");
            const mem_y = document.querySelector("#mem_y");
            const mem_n = document.querySelector("#mem_n");
    ...
    public function previewAdminStory($subject, $hometext, $bodytext, $topic, $catid, $ihome, $members, $Mmembers, $dd_pub, $fd_pub, $dh_pub, $fh_pub, $epur)
    {
        ...
        $arg1 = 'var formulid = ["storiespreviswart"];
            inpandfieldlen("subject",255);
            const choixgroupe = document.getElementById("choixgroupe");
            const mem_y = document.querySelector("#mem_y");
            const mem_n = document.querySelector("#mem_n");
