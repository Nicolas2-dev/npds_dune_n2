...
class Blocks extends AdminBaseController
{
    ...
    public function droitsBloc($member, $j, $lb)
    {
        ...
        echo '<input type="radio" id="adm' . $j . $lb . '" name="members" value="-127" ' . $checked . ' class="form-check-input" />
        ...
        echo '<input type="radio" id="ano' . $j . $lb . '" name="members" value="-1" ' . $checked . ' class="form-check-input" />
        ...
        if ($member > 0) {
            echo '<input type="radio" id="mem' . $j . $lb . '" name="members" value="1" checked="checked" class="form-check-input"/>
            ...
            echo '<input type="radio" id="mem' . $j . $lb . '" name="members" value="1" class="form-check-input" />
                    <label class="form-check-label" for="mem' . $j . $lb . '">' . adm_translate('Membres') . '</label>
                </div>
                <div class="form-check form-check-inline">
    ...
    public function blocks()
    {
        ...
        if ($num_row > 0) {
            ...
            while (list($id, $title, $content, $member, $Lindex, $Scache, $Sactif, $BLaide, $css) = sql_fetch_row($result)) {
                ...
                echo '<td class="d-none d-sm-table-cell" align="right">' . $Lindex . '</td>
        ...
        if ($num_row > 0) {
            ...
            while (list($id, $title, $content, $member, $Rindex, $Scache, $Sactif, $BRaide, $css) = sql_fetch_row($result)) {
                ...
                echo '<td class="d-none d-sm-table-cell text-end">' . $Rindex . '</td>
