...
function reviews()
{
    ...
    if ($numrows > 0) {
        while (list($id, $date, $title, $text, $reviewer, $email, $score, $url, $url_title) = sql_fetch_row($result)) {
            ...
            echo '<h4 class="my-3">' . adm_translate('Ajouter la critique N° : ') . ' ' . $id . '</h4>
            ...
            echo '<div class="mb-3 row">
                    ...
                    <div class="col-sm-8">
                        ...
                        <span class="help-block">150*150 pixel => assets/shared/covers<span class="float-end ms-1" id="countcar_cover' . $id . '"></span></span>
                    </div>
                </div>
                <div class="mb-3 row">
            ...
            $jsfvc .= 'inpandfieldlen("title' . $id . '",40);
        ...
        $arg1 = 'var formulid = ["reviewspagecfg"' . $jsfvf . '];
