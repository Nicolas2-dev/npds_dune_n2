...
class Reply extends FrontBaseController
{
    ...
    public function index()
    {
        ...
        if ($submitS) {
            ...
            if ($allow_to_reply) {
                ...
                echo '<textarea id="ta_replypost" class="form-control" ' . $xJava . ' name="message" rows="15">' . $reply . '</textarea>
                        </div>
            ...
            if ($allow_to_reply) {
                ...
                do {
                    ...
                    echo '</span>
                        ...
                        <div class="card-body">
                            <span class="text-body-secondary float-end small" style="margin-top:-1rem;">' . translate('Posté : ') . Date::formatTimes($myrow['post_time'], IntlDateFormatter::MEDIUM, IntlDateFormatter::SHORT) . '</span>
