...
{
    if (file_exists($path = 'storage/meta/meta.php')) {
        ...
        <body class="my-3 mx-3">
            ...
            <p class="h4 my-3">
                <i class="me-1 far fa-file-alt"></i>' . $a . ' ' . $b . ' <span class="text-body-secondary">[ Documentation ]</span>
            </p>';
    }
}
...
function docfoot()
{
    echo '<p class="text-end small my-3 text-body-secondary">Autodoc by NPDS</p>
    </body>
    </html>';
}
...
function docu()
{
    echo '<p class="h5 my-3">Mainfile.php</p>';

    autodoc('mainfile.php', 'Mainfile.php');

    echo '<p class="h5 my-3">Powerpack_f.php</p>';
    ...
    echo '
        <div class="alert alert-success mt-3">
            Rappels :
            <br />
            Si votre thème est adapté, chaque bloc peut contenir :
            <br />
            - class-title#nom de la classe de la CSS pour le titre du bloc
            <br />
            - class-content#nom de la classe de la CSS pour le corps du bloc
            <br />
            - uri#uris séparée par un espace
        </div>
        <p class="text-end small my-3 text-body-secondary">
            Autodoc by NPDS
        </p>
    </body>
    </html>';
