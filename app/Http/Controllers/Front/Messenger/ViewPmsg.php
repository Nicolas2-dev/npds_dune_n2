...
class ViewPmsg extends FrontBaseController
{
    ...
    public function index()
    {
        ...
        if (!$user) {
            ...
            echo '<option ' . $sel . ' value="All">' . translate('Tous les sujets') . '</option>
                        </select>
                    </div>
                </form>';
            ...
            if (!$total_messages = sql_num_rows($resultID)) {
                ...
                echo '<form name="prvmsg" method="get" action="replypmsg.php" onkeypress="return event.keyCode != 13;">
                ...
                echo '<th data-halign="center" data-sortable="true" data-align="left">' . translate('de') . '</th>
            ...
            echo '<th data-halign="center" data-sortable="true" data-align="center">' . translate('Envoyé à') . '</th>
